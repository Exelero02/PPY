...
# Convert Input:
converted = [int(x) for x in input_numbers.split()]
# Sorting:
numbers_list = sorted(converted)
...
try:
    ...
    numbers_tuple.remove(convert_tuple[0])
except AttributeError:
...
numbers_dict = {num: num for num in numbers_list}
...
try:
    ...
    print("What are you doing bro, it's a tuple!")
# Set Operations
set1 = set(numbers_list)
set2 = {8, 10, 11, 12}
set_union = set1.union(set2)
...
with open("output.txt", "r") as file:
    ...
    num_lines = len(lines)
    num_integers = sum(line.count("Original List") for line in lines)
...
with open("output.txt", "r") as file:
    for line in file:
        ...
        print("Largest number has not found :[")
        exit()
...
print("Is the largest integer itself prime?", largest_integer_prime)
...
with open("prime_numbers.txt", "w") as file:
    ...
    file.write(f"Is the largest integer itself prime? {largest_integer_prime}\n")
